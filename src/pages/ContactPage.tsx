...
const OFFICES = [
  {
    city: 'Dubai HQ',
    address: '123 Industrial Zone, Sector 4, Al Quoz\nDubai, United Arab Emirates',
    phone: '+971 4 123 4567',
    email: 'sales@zebtrading.com',
    hours: 'Mon – Sat: 8:00 AM – 6:00 PM',
  },
  {
    city: 'Abu Dhabi Office',
    address: '45 Mussafah Industrial Area\nAbu Dhabi, United Arab Emirates',
    phone: '+971 2 456 7890',
    email: 'abudhabi@zebtrading.com',
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-16 bg-secondary border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            Have a parts enquiry, wholesale quote request, or just want to know more about ZEB Trading? Our team is ready to help — 24/7.
          </p>
        </div>
      </section>
      ...
      <div className="border-b border-border bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap gap-6 justify-start">
            <a href="tel:+97141234567" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors font-medium">
              <Phone className="w-4 h-4 text-primary" /> +971 4 123 4567
            </a>
            <a href="mailto:info@zebtrading.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors font-medium">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium">
              <Headphones className="w-4 h-4 text-green-400" /> Emergency line available 24/7
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                <h2 className="text-2xl font-display font-bold text-foreground mb-6 uppercase">Our Offices</h2>
                {OFFICES.map((office) => (
                  <div key={office.city} className="bg-card border border-border rounded-xl p-6 mb-4 hover:border-primary/40 transition-colors">
                    <div className="flex items-center gap-2 mb-4">
                      <Building2 className="w-4 h-4 text-primary" />
                      <h3 className="font-display font-bold text-foreground uppercase tracking-wide">{office.city}</h3>
                    </div>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-display font-bold text-foreground uppercase">Chat on WhatsApp</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-4">
                  Get instant replies from our parts team via WhatsApp. Share photos, OEM numbers, or vehicle details directly.
                </p>
                <a
              ...
              >
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-2xl font-display font-bold text-foreground mb-3 uppercase">Message Received!</h3>
                    <p className="text-muted-foreground mb-2">Thank you, <span className="text-foreground font-semibold">{formData.name}</span>.</p>
                    <p className="text-muted-foreground mb-8 text-sm">One of our specialists will reach out to <span className="text-foreground">{formData.email}</span> within 2 business hours.</p>
                    <button
                      onClick={handleReset}
                  ...
                  <>
                    <h3 className="text-2xl font-display font-bold text-foreground mb-2 uppercase">Send Us a Message</h3>
                    <p className="text-muted-foreground text-sm mb-8">Fill in the form and our team will respond within 2 business hours.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Company / Workshop</label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Inquiry Type *</label>
                        <select
                          required
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Vehicle Information (Optional)</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Message / Parts List *</label>
                        <textarea
                          required
                          rows={5}
      ...
      <section className="h-72 bg-secondary border-t border-border relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center flex-col gap-3">
          ...
          <p className="text-muted-foreground font-semibold text-sm uppercase tracking-widest">ZEB Trading HQ — 123 Industrial Zone, Dubai</p>
          <a
            href="https://maps.google.com/?q=Al+Quoz+Industrial+Area+Dubai"
            target="_blank"
            rel="noopener noreferrer"
